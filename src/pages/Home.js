  ...
  return (
    <div className="w-full flex flex-col justify-center text-white">
      ...
      <div className="w-full min-h-screen flex flex-col justify-center items-center">
        ...
        <p className="font-medium text-lg">the premier car detailing studio</p>
      </div>

      {/* About Us */}
      <div className="w-full min-h-screen p-36 text-lg">
        <h2 className="text-4xl font-semibold uppercase font-chakra my-4">About Us</h2>
