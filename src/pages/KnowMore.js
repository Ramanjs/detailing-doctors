export default function KnowMore() {
  return (
    <div className="w-full bg-white p-4 border-b-2 border-gray-400">
      <div className="w-full py-4 px-8 bg-[#EDEDED] flex justify-between items-center rounded-md">
        ...
        <div className="w-[40%] flex flex-col px-8 border-l-2 border-l-[#BBBBBB]">
